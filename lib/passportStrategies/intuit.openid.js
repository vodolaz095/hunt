...
exports.routes = function (core,router) {
  router.get('/intuit', core.passport.authenticate('intuit'));
  router.get('/intuit/callback', core.passport.authenticate('intuit', {
    failureRedirect: '/auth/failure?strategy=intuit',
    successRedirect: '/auth/success?strategy=intuit'
  }));
};
