...
//routes for signUp
    core.app.post('/isBusy', function (request, response) {
    ...
    core.app.post('/signup', function (request, response) {
...
//route to ask for password reset email
    core.app.post('/restoreAccount', function (request, response) {
...
//route to render page with form to reset password
    core.app.get('/reset/:welcomeLink', function (request, response) {
      if (request.user) {
        response.redirect('/');
      } else {
...
//route to reset password
    core.app.post('/resetPassword', function (request, response) {
