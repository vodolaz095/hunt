...
//todo - more detailed example
      ...
      core.extendCore('restErrors', function (core) {
        return require('./toRest/errors.js');
      });
      core.extendCore('preload', function (core) {
        return require('./toRest/preload.js');
      });
      ...
      throw new Error('Hunt.exportModelToRest() - modelName is not defined or corresponding model (' + parameters + ') does not exist!');
    }
  };
};
