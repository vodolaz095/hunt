...
//openid
  ...
  [
    ...
    if (core.config.passport[strategyName]) {
 ...
 * @property {boolean} yahoo - authorization by Yahoo openId - default is false - disabled.
 * @property {boolean} steam - authorization by Steam openId - default is false - disabled.
 * @property {boolean} paypal - authorization by Paypal openId - default is false - disabled.
 * @property {boolean} intuit - authorization by Intuit openId - default is false - disabled.
 *
