...
//emit event to all (authorized and anonymous) socket.io clients
    /**
     * Broadcast message by socket.io to all socket.io clients both authorized and non authorized site visitors
     *
...
//https://github.com/LearnBoost/socket.io/wiki/Exposed-events#server
      /**
       * Event is emitted each time the socket.io client sends the message by this client side javascript code
       * @example
       *
       * ```javascript
       *
       ...
       *  @type {object}
       *  @property {User|null} user - user, associated with this socket.io socket, or null if user is not authorized
...
//notifying user by means of User#notify
