...
//oauth strategies
  ...
  if (core.config.passport.GOOGLE_CONSUMER_KEY && core.config.passport.GOOGLE_CONSUMER_SECRET) {
 ...
 *
 * @property {string} GOOGLE_CONSUMER_KEY - used to authorize users by {@link https://developers.google.com/accounts/docs/OAuth2 | Google OAuth 2.0 strategy}, obtainable in {@link https://console.developers.google.com/ Google Developers' console }
 * @property {string} GOOGLE_CONSUMER_SECRET  - used to authorize users by {@link https://developers.google.com/accounts/docs/OAuth2 | Google OAuth 2.0 strategy}, obtainable in {@link https://console.developers.google.com/ Google Developers' console }
